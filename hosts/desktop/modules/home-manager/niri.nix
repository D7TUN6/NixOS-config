{pkgs, ...}: let
  rec-live = pkgs.writeShellScriptBin "rec-live" ''
    read -p 'file name: ' fn
    read -p 'extension: ' ext
    exec pw-record -P '{ stream.capture.sink=true }' "$HOME/files/mounts/wd-purple/files/content/1_music/live/$fn.$ext"
  '';
in {
  home.file.".config/niri/config.kdl" = {
    text = ''
      ...
      output "DP-1" {
          ...
          //mode custom=true "1792x1344@60"
          //mode custom=true "1560x1170@70"
          //mode custom=true "1600x1200@69"
          //mode custom=true "1472x1104@75"
          //mode custom=true "1152x864@90"
          //mode custom=true "1024x768@105"
          //mode custom=true "640x480@162"
          modeline 103.94 1024 1056 1136 1280 768 771 777 812 "-hsync" "+vsync"
      ...
      output "DVI-D-2" {
          //mode "1920x1080@60"
          modeline 164.70 1920 1928 1960 2000 1080 1081 1089 1098 "+hsync" "-vsync"
          position x=1024 y=0
      }
      ...
      binds {
          ...
          Mod+Alt+R { spawn "foot" "${rec-live}/bin/rec-live"; }
          ...
          Mod+Shift+S { spawn "foot" "--app-id" "foot-floating" "sh" "-c" "nrs || read -p 'Error! Press enter...'"; }
          Mod+Shift+H { spawn "foot" "--app-id" "foot-floating" "sh" "-c" "hms || read -p 'Error! Press enter...'"; }
          Mod+Shift+M { spawn "foot" "--app-id" "foot-floating" "sh" "-c" "nm|| read -p 'Error! Press enter...'"; }
          Mod+Shift+Y { spawn "foot" "--app-id" "foot-floating" "sh" "-c" "nsr|| read -p 'Error! Press enter...'"; }
